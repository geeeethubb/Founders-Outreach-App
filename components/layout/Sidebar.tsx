...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[240px] min-h-screen bg-slate-900 flex flex-col fixed left-0 top-0 bottom-0">
      {/* Brand */}
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-slate-500 text-xs leading-tight">Career &amp; Outreach OS</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-slate-800">
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 w-full text-slate-400 hover:text-white text-sm rounded-lg hover:bg-slate-800 transition-colors"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
